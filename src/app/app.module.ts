...
@NgModule({
  declarations: [AppComponent, ListTaskComponent, StatusTaskDirective, ConfirmDeleteDirective, CompletedTasksComponent, DetailsTasksComponent, DeletedTasksComponent, LoginComponent],
